...
contract('INXToken', function ([_, owner, recipient, anotherAccount, extraAccount, founder, inxPlatform]) {
    ...
    const TOTAl_AMOUNT_OF_TOKENS = ZERO;
    ...
    describe('whitelist', function () {
        ...
        context('minting conditions', function () {
            it('should allow owner to mint as automatically whitelisted', async function () {
                ...
                newTotalBalance.should.be.bignumber.equal(totalBalance.add(ONE));
            });
    ...
    describe('transfer', function () {
        describe('when the recipient is not the zero address', function () {
            ...
            describe('when the sender does not have enough balance', function () {
                const amount = TOTAl_AMOUNT_OF_TOKENS.add(new BigNumber('1'));
    ...
    describe('approve', function () {
        describe('when the spender is not the zero address', function () {
            ...
            describe('when the sender does not have enough balance', function () {
                const amount = TOTAl_AMOUNT_OF_TOKENS.add(ONE);
    ...
    describe('decrease approval', function () {
        describe('when the spender is not the zero address', function () {
            ...
            describe('when the sender has enough balance', function () {
                ...
                describe('when the spender had an approved amount', function () {
                    beforeEach(async function () {
                        await this.token.approve(spender, amount.add(ONE), {from: owner});
                    });
            ...
            describe('when the sender has enough balance', function () {
                ...
                describe('when the spender had an approved amount', function () {
                    ...
                    it('increases the spender allowance adding the requested amount', async function () {
                        ...
                        const allowance = await this.token.allowance(owner, spender);
                        allowance.should.be.bignumber.equal(amount.add(ONE));
                    });
                });
            });
